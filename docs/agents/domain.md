...
- **`docs/adr/`** — read ADRs that touch the area you're about to work in. The 12 current ADRs (0001-0012) record the decisions (D1-D12) of the software architecture evolution to the five-layer contract layering (App/Service/Platform/Impl/Vendor).
