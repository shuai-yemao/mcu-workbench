...
```bash
# 扫描开源驱动代码
python3 skills/impl/impl_board/references/capabilities/bsp-device-adaptation/scripts/bsp_adapter.py --scan ./downloaded_driver/

# 适配开源驱动到 BSP 规范
python3 skills/impl/impl_board/references/capabilities/bsp-device-adaptation/scripts/bsp_adapter.py \
...
# 列出已记录的设备
python3 skills/impl/impl_board/references/capabilities/bsp-device-adaptation/scripts/bsp_adapter.py --list-devices
```
...
```bash
python3 skills/impl/impl_board/references/capabilities/bsp-device-adaptation/scripts/bsp_adapter.py --scan ./mpu6050_lib/
```
...
在 `bsp-device-adaptation` skill 中，推荐工作流是：
