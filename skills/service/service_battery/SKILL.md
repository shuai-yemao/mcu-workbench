...
description: Service 业务服务：电量计算、电压/充电状态、低电量告警策略（带业务策略，非驱动封装）。
---
...
Service 是 **App 常见业务抽象**（D10）：把产品业务中可沉淀、可复用的能力组织成服务，**带业务策略**，不是驱动的简单封装，也不是中间件封装。本服务只依赖 Platform 接口（platform_bsp/battery 能力接口），不 include Vendor / Impl / HAL 任何符号。

## 业务策略

电量百分比计算（电压/库仑积分）、低电量阈值告警、充电状态机（充电/满电/放电/低电/关机）。
