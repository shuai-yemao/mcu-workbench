...
const DOMAINS = {
  ...
  hardware: {
    ...
    layers: ['hardware'],
    extraSkills: ['platform_mcu', 'platform_bsp', 'impl_board', 'impl_bsp', 'tools-debug', 'tools-observability'],
    keywords: [
  ...
  verification: {
    label: '验证质量',
    layers: [],
    extraSkills: ['tools-quality', 'tools-verification', 'tools-debug', 'tools-observability', 'tools-build', 'tools-release'],
    keywords: [
      '测试', '验证', '回归', '质量', '审查', '静态分析',
