...
const LAYERS = [
  ...
  },
  {
    ...
    responsibility: '平台抽象（纯定义，零实现）：统一接口/错误码/数据结构/ops/ctx。',
    allowed: '仅标准类型。',
    forbidden: '任何实现、芯片头文件、HAL/RTOS/Vendor 类型；Platform 目录不允许 .c 文件。'
  },
  {
