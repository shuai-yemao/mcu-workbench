...
const LAYERS = [
  {
    id: 'app', name: 'APP', patterns: [/(?:^|\/)(?:App|Application|User_Task)(?:\/|$)/i, /(?:^|\/)01_App(?:\/|$)/i],
  ...
  {
    id: 'os', name: 'OS', patterns: [/(?:^|\/)(?:OS|System|os_adapter)(?:\/|$)/i, /(?:^|\/)04_Impl\/impl_os(?:\/|$)/i],
  ...
  {
    id: 'bsp', name: 'BSP', patterns: [/(?:^|\/)Bsp(?:\/|$)/i, /(?:^|\/)BSP(?:\/|$)/, /(?:^|\/)03_Platform\/platform_bsp(?:\/|$)/i, /(?:^|\/)04_Impl\/impl_(?:bsp|bsp_handler|board)(?:\/|$)/i],
  ...
  {
    id: 'core', name: 'Core', patterns: [/(?:^|\/)Core(?:\/|$)/i, /(?:^|\/)03_Platform\/platform_mcu(?:\/|$)/i],
