...
const DEFAULT_LAYOUT = {
  ...
  osPort: [/(?:^|\/)os_adapter\/(?:FreeRTOS|RT-Thread|RTThread|BareMetal)(?:\/|$)/i, /^OS\/Port(?:\/|$)/i, /(?:^|\/)04_Impl\/impl_os\/(?:port|ports?|freertos|rtthread|baremetal)(?:\/|$)/i]
};
...
const BSP_HAL_DRIVER_CONCRETE_DEPENDENCY = /#\s*include\s*[<"][^>"]*(?:stm32|hal|freertos|rtthread|cmsis_os|osal|drv_adapter|platform_)[^>"]*[>"]/gi;
