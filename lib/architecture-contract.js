...
const DEFAULT_LAYOUT = {
  ...
  bspWrapper: [/^Bsp\/Wrapper(?:\/|$)/i, /^Bsp\/.*\/[^/]*wrapper[^/]*\.[ch]$/i, /(?:^|\/)03_Platform\/platform_bsp(?:\/|$)/i],
...
const BSP_HANDLER_INJECTION_DEPENDENCY = /#\s*include\s*[<"][^>"]*(?:drv_adapter_(?:port|wrapper)|core_|mcu_|platform_|stm32|hal|freertos|rtthread|osal_internal|bsp_[^>"]*_driver)[^>"]*[>"]/gi;
