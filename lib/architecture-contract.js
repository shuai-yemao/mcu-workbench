...
const DEFAULT_LAYOUT = {
  ...
  bspPort: [/^Bsp\/(?:Port|Porting)(?:\/|$)/i, /^Bsp\/.*\/[^/]*port[^/]*\.[ch]$/i, /(?:^|\/)04_Impl\/impl_board(?:\/|$)/i],
...
const BSP_HANDLER_INJECTION_DEPENDENCY = /#\s*include\s*[<"][^>"]*(?:drv_adapter_(?:port|wrapper)|core_|mcu_|platform_(?![A-Za-z0-9_]+_model\.h)|stm32|hal|freertos|rtthread|osal_internal|bsp_[^>"]*_driver)[^>"]*[>"]/gi;
