...
const BSP_HANDLER_INJECTION_DEPENDENCY = /#\s*include\s*[<"][^>"]*(?:drv_adapter_(?:port|wrapper)|core_|mcu_|platform_(?:mcu|os|adc|dma|event|gpio|i2c|irq|reset_reason|spi|tick|timer|uart|watchdog)|stm32|hal|freertos|rtthread|osal_internal|bsp_[^>"]*_driver)[^>"]*[>"]/gi;
    ...
    if (isBspPort) {
      ...
      for (const registration of registrations) {
        ...
        const requiredInjections = modelFirst ? [
          ...
          ['BSP_PORT_MODEL_OPS_BINDING', /\.read_id\s*=\s*impl_[A-Za-z0-9_]+_handle_read_id\s*,/],
