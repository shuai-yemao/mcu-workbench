...
# 分层扫描/同步/校验(scripts/claude-layer-api.js;原 Node CLI 已移除)
node scripts/claude-layer-api.js scan --root <firmware-root>
node scripts/claude-layer-api.js init --root <firmware-root> --write
node scripts/claude-layer-api.js validate --root <firmware-root> --strict
```
